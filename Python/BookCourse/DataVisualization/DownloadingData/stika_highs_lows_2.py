...
ax.plot(dates, highs, c='red', alpha=0.5) # v.4 v.5 v.l.2
ax.plot(dates, lows, c='blue', alpha=0.5) # v.l.1 v.l.2
ax.fill_between(dates, highs, lows, facecolor='blue', alpha=0.1) # v.l.2
