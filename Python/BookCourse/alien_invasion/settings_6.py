class Settings:
    ...
    def __init__(self):
        ...
        self.speedup_scale = 1.5 # v.6

        # How quickly the alien point values increase
        self.score_scale = 1.5 # v.6

        self.initialize_dynamic_settings() # v.6

    def initialize_dynamic_settings(self): # v.6
        ...
        # Scoring
        self.alien_points = 50 # v.6

    def increase_speed(self): # v.6
